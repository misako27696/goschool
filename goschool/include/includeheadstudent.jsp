	...
	<div id="goschool">
		...
		<div id="box">
			...
			<ul>
						<li id="span">|</li>
   						<li>
   							<form id="fm" action="/goschool/classroomstudent" method="POST">
   								<input type="submit" id="sb" value="クラスルーム">
   							</form>
   						</li>
   						<li id="span">|</li>
  						<li>
  							<form id="fm" action="/goschool/mypagestudent" method="POST">
  								<input type="submit" id="sb" value="マイページ">
  							</form>
  						</li>
						<li id="span">|</li>
  						<li>
  							<form id="fm" action="/goschool/student/CalendarStudent.jsp" method="POST">
  								<input type="submit" id="sb" value="カレンダー">
  							</form>
  						</li>
  						<li id="span">|</li>
  						<li>
  							<form id="fm" action="/goschool/student/settingProfileStudent.jsp" method="POST">
