    ...
    <jsp:include page="../include/includeheadteacher.jsp" flush="true" />
        ...
        <br />
			...
			<div class="box settingmail" style="text-align:center;"><br />
				<p style="font-size:25px;">招待した先生のメールアドレスを入力してください。</p>
				<form name="setting_pass"><br /><br />
				
					<input type="email" style="size:100px;width:500px;height:30px;font-size:20px;">
				
				</form>
				
				<br /><br />
				<input type="button" value="送信" class="mail-change-button" />
	<br/><br/>
</div>
        </div>
