  ...
  //現在の年数オブジェクトを4桁で生成
   ...
   for (var i = 1; i <= 31; i++) {
    ...
    <jsp:include page="../include/includeheadteacher.jsp" flush="true" />
    	<div id="side-left"><p>>> 設定 - パスワード設定</p>
        ...
        <br>
			...
			<div class="box settingpass"><br />
				<p style="font-size:25px;">パスワードの変更</p>
				<form name="setting_pass">
					<p style="margin-right:300px;">現在のパスワードを入力してください。</p>
					<input type="password" style="margin-right:400px;">
					
					<p style="margin-right:300px;">新しいパスワードを入力してください。</p>
					<input type="password" style="margin-right:400px;">
					
					<p style="margin-right:300px;">確認用にもう一度入力してください。</p>
					<input type="password" style="margin-right:400px;">
				...
				<input type="button" value="変更" class="pass-change-button" />
