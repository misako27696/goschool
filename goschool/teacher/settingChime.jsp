   ...
   for (var i = 1; i <= 31; i++) {
    ...
    <jsp:include page="../include/includeheadteacher.jsp" flush="true" />
        ...
        <br>
			...
			<div class="box settingchime"><br />
				<p style="font-size:25px;">メールの通知の変更</p>
				<form name="setting_pass">
					<p>下記のメールアドレスに通知の設定をしてください。</p><br />
					<input type="radio" name="chime" value="yes" checked="checked">通知する
					<input type="radio" name="chime" value="no" style="margin-left:150px;">通知しない
				
				</form>
				
				<br />
				
				<input type="button" value="変更" class="mail-change-button" />
