...
<jsp:include page="../include/script_classroom.jsp" flush="true" />
    ...
    <jsp:include page="../include/includeheadstudent.jsp" flush="true" />
    	    	...
    	    	<div id="side-left"><p>>> クラスルーム</p>
    	    	<div style="margin-left:30px;">
    	<a href="#attendance" name="modal">
        <input type="submit" value="今日の出席状況を登録" class="btn" style="width:250px">
        </a>
        </div>
        <br><br>
    	...
    	<div id="main">
			<div id="class_atend">
			<form action="/goschool/classroomstudent" method="post">
			...
			<div id="attendance" class="window">
				...
				<form name="class_make" action="/goschool/classroomstudent" method="post">
									...
									<ol id="todokede_list">
										<select name="todokede_list_0">
											...
											for ( int i = 0; i < members.size(); ++i ) {
												...
												out.println("<option value=\"" + student_id + "\">"
															+ student_number+":"+lastname+firstname + "</option>");
											}
											%>
										</select>
									</ol>
						...
						<!-- 欠課 -->
							<ul>
								<li>欠課<input type="button" value="欠席を追加" id="btn_kekka">
									<ol id="kekka_list">
										<li>
											<select name="time" style="width:90px">
												<option value="0">欠席時限</option>
